...
> **Explicit invocation only**: This workflow should only run when the user explicitly requests it with `hotfix`. Do not auto-run based on context matching.
...
6b. **Collect approvals** — Use the delegation step to request sign-off:
