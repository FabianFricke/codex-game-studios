---
name: setup-engine
description: "Configure the project's game engine and version. Pins the engine in AGENTS.md, detects knowledge gaps, and populates engine reference docs via web search when the version is beyond the model's training data."
---
...
## 4. Update AGENTS.md Project Configuration

Read `AGENTS.md` and update the `Project Configuration` section. Replace the
...
If used as `setup-engine refresh`:
