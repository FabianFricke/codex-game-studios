...
> **Explicit invocation only**: This workflow should only run when the user explicitly requests it with `release-checklist`. Do not auto-run based on context matching.
