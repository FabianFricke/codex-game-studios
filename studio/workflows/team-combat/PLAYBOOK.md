...
---
When this workflow runs, orchestrate the combat team through a structured pipeline.
...
Always provide full context in each delegated brief (design doc path, relevant code files, constraints). Launch independent workstreams in parallel where the pipeline allows it.
