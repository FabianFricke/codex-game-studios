...
---
When this workflow runs, orchestrate the narrative team through a structured pipeline.
...
Use the delegation step to assign each team member a focused subagent:
