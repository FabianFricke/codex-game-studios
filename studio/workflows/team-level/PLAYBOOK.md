...
Always provide full context in each delegated brief (game concept, pillars, existing level docs, narrative docs).

3. **Orchestrate the level design team** in sequence:

### Step 1: Narrative Context (narrative-director + world-builder)
Delegate to `narrative-director` to:
...
Delegate to `systems-designer` to:
