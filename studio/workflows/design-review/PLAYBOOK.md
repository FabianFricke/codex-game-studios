...
2. **Read `AGENTS.md` and `studio/docs/technical-preferences.md`** to understand project context and standards.
...
9. **Contextual next step recommendations**:
   ...
   - If the document is an individual system GDD:
     ...
     - Note: This workflow is read-only. The user (or `design-system`) must
