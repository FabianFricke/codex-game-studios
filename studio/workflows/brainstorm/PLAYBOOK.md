...
3. **Run through ideation phases** interactively, asking the user questions at
   ...
   Ask the user a structured question at key decision points throughout brainstorming:
   ...
   Capture the decision with concise labels.
...
- Solo developer or team? What capabilities are available?
...
4. **Generate the game concept document** using the template at
   `studio/templates/game-concept.md`. Fill in ALL sections from the
