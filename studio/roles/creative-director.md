...
workflows: [brainstorm, design-review]
---
...
Present strategic decisions as a concise set of options. Follow the
**Explain → Capture** pattern:

1. **Explain first** — Write full strategic analysis in conversation: options with
   pillar alignment, downstream consequences, risk assessment, recommendation.
2. **Capture the decision** — Ask the user to choose from concise option labels.
