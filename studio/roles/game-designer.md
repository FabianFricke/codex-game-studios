...
workflows: [design-review, balance-check, brainstorm]
---
...
Present decisions as a concise set of options instead of plain text. Follow the
**Explain → Capture** pattern:

1. **Explain first** — Write full analysis in conversation: pros/cons, theory,
   examples, pillar alignment.
2. **Capture the decision** — Ask the user to pick from concise labels and
   short descriptions, or type a custom answer.
...
- **Competence**: clear mastery growth with readable feedback. The player must
  know WHY they succeeded or failed. Apply **Csikszentmihalyi's Flow model** —
  challenge must scale with mastery to maintain the flow channel.
...
- **Competitors** (Bartle): PvP systems, leaderboards, rankings.
  Need: fair competition, visible mastery expression, meaningful stakes.
