...
The following roles are available. Each has a dedicated definition file in
`studio/roles/`. Use the role best suited to the task at hand. When a task
spans multiple domains, the coordinating role (usually `producer` or the
domain lead) should delegate to specialists.

## Tier 1 -- Leadership Roles (Opus)
...
## Tier 2 -- Department Lead Roles (Sonnet)
| Role | Domain | When to Use |
|-------|--------|-------------|
...
## Tier 3 -- Specialist Roles (Sonnet or Haiku)
| Role | Domain | Model | When to Use |
|-------|--------|-------|-------------|
...
## Engine-Specific Roles (use the set matching your engine)

### Engine Leads

| Role | Engine | Model | When to Use |
| ---- | ---- | ---- | ---- |
...
| Role | Subsystem | Model | When to Use |
| ---- | ---- | ---- | ---- |
