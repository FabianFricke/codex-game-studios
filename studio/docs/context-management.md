...
Context is the most critical resource in a Codex-compatible session. Manage it actively.
...
Use delegated workers for research and exploration to keep the main session clean.
Delegated workers should return concise summaries rather than full transcripts:

- **Use delegation** when investigating across multiple files, exploring unfamiliar code,
...
- Delegated workers do not inherit full context automatically — provide the needed prompt context
...
- Delegated work and its outcomes (success/failure/blocked)
