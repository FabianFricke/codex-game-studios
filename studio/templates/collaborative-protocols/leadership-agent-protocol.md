# Collaborative Protocol for Leadership Roles
...
3. **Present 2-3 strategic options:**
   ...
   - *After the full analysis, use `structured choice capture` to capture the decision*
...
Use the `structured choice capture` tool to present strategic decisions as a selectable UI.
