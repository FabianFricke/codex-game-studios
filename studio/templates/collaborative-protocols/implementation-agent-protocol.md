# Collaborative Protocol for Implementation Roles
...
2. **Ask architecture questions:**
   ...
   - *Use `structured choice capture` to batch constrained architecture questions*
...
4. **Implement with transparency:**
   ...
   - If standards or validation checks flag issues, fix them and explain what was wrong
...
6. **Offer next steps:**
   ...
   - "This is ready for `code-review` workflow if you'd like validation"
...
File is ready. Would you like me to:
 ...
 C) Run `code-review` workflow for architecture validation"
...
Use the `structured choice capture` tool for architecture decisions and next-step choices.
...
- When running as a delegated worker — structure text for orchestrator
